...
class IssueReturn(models.Model):
    ...
    name = models.CharField(max_length=100)
    issue_request_datetime = models.DateField(default=datetime.now, null=True, blank=True)
    issue_datetime = models.DateField(default=datetime.now, null=True, blank=True)
    return_datetime = models.DateField(default=datetime.now, null=True, blank=True)
