...
SECRET_KEY = 'django-insecure-khm^@ee-hs376m#ndk-+@_o)j&-6z0%e$3v0li=dj4tqo#lx3o'
...
INSTALLED_APPS = [
    ...
    'emp_work.apps.EmpWorkConfig',
    'fix_assets.apps.FixAssetsConfig',
    'sports.apps.SportsConfig',
    'computer.apps.ComputerConfig',
    'consumable_assets.apps.ConsumableAssetsConfig',
